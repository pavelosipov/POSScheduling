...
@implementation UIDevice (SODInfrastructure)

+ (NSString *)sod_platformName {
    //  https://www.theiphonewiki.com/wiki/
    NSString *platform = [UIDevice p_platform];
    ...
    if ([platform isEqualToString:@"iPad4,3"])      return @"iPad Air (LTE)";
    if ([platform isEqualToString:@"iPad5,3"])      return @"iPad Air 2 (WiFi)";
    if ([platform isEqualToString:@"iPad5,4"])      return @"iPad Air 2 (Cellular)";
    if ([platform isEqualToString:@"iPad6,7"])      return @"iPad Pro 12 (WiFi)";
    ...
    if ([platform isEqualToString:@"iPad4,5"] ||
        [platform isEqualToString:@"iPad4,6"])      return @"iPad mini 2G (Cellular)";
    if ([platform isEqualToString:@"iPad4,7"])      return @"iPad mini 3 (WiFi)";
    if ([platform isEqualToString:@"iPad4,8"] ||
        [platform isEqualToString:@"iPad4,9"])      return @"iPad mini 3 (Cellular)";
